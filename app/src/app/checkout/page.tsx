  ...
  return (
    <ScreenShell>
      ...
      <div className="bg-surface rounded-2xl border border-border p-4 mb-4">
        ...
        <button className="w-full bg-white text-black rounded-xl py-3 font-semibold text-base flex items-center justify-center gap-2 hover:bg-gray-100 transition-colors">
